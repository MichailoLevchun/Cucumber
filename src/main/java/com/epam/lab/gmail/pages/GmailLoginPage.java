...
public class GmailLoginPage {
	public static final String LOGIN_PAGE_URL = "https://gmail.com/";
	...
	public GmailLoginPage() {
		LOG.info("GmailLoginPage constructor");
	...
	public void typeLoginAndSubmit(String login) {
		LOG.info("typeLoginAndSubmit method");
		loginInput.sendKeys(login);
		nextButton.click();
	}

	public void typePasswordAndSubmit(String password) {
		LOG.info("typePasswordAndSubmit method");
